...
::std::ostream&
operator<< (::std::ostream& o, const DataArrayList_t& i)
{
  return o << static_cast< const ::xsd::cxx::tree::list< ::xml_schema::decimal, char, ::xsd::cxx::tree::schema_type::decimal >& > (i);
}

::std::ostream&
operator<< (::std::ostream& o, const DataArray_t& i)
{
  o << static_cast< const ::DataArrayList_t& > (i);

  o << ::std::endl << "type: " << i.type ();
  o << ::std::endl << "Name: " << i.Name ();
  o << ::std::endl << "NumberOfComponents: " << i.NumberOfComponents ();
...
::std::ostream&
operator<< (::std::ostream& o, const PieceUnstructuredGrid_t& i)
{
  o << ::std::endl << "PointData: " << i.PointData ();
  o << ::std::endl << "CellData: " << i.CellData ();
  o << ::std::endl << "Points: " << i.Points ();
  o << ::std::endl << "Cells: " << i.Cells ();
  o << ::std::endl << "NumberOfPoints: " << i.NumberOfPoints ();
  o << ::std::endl << "NumberOfCells: " << i.NumberOfCells ();
  return o;
}

::std::ostream&
operator<< (::std::ostream& o, const UnstructuredGrid_t& i)
{
  o << ::std::endl << "Piece: " << i.Piece ();
  return o;
}

::std::ostream&
operator<< (::std::ostream& o, const PolyData_t& i)
{
  o << ::std::endl << "greeting: " << i.greeting ();
  return o;
}

::std::ostream&
operator<< (::std::ostream& o, const VTKFile_t& i)
{
  if (i.UnstructuredGrid ())
  {
    o << ::std::endl << "UnstructuredGrid: " << *i.UnstructuredGrid ();
  }

  if (i.PolyData ())
  {
    o << ::std::endl << "PolyData: " << *i.PolyData ();
  }

  o << ::std::endl << "type: " << i.type ();
  o << ::std::endl << "version: " << i.version ();
  o << ::std::endl << "byte_order: " << i.byte_order ();
  return o;
}
...
::std::ostream&
operator<< (::std::ostream& o, const PointData& i)
{
  for (PointData::DataArray_const_iterator
       b (i.DataArray ().begin ()), e (i.DataArray ().end ());
       b != e; ++b)
  {
    o << ::std::endl << "DataArray: " << *b;
  }
...
::std::ostream&
operator<< (::std::ostream& o, const CellData& i)
{
...
::std::ostream&
operator<< (::std::ostream& o, const Points& i)
{
...
::std::ostream&
operator<< (::std::ostream& o, const Cells& i)
{
